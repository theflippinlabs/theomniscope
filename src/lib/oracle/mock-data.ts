...
/**
 * Seeded Oracle Sentinel demo data.
 *
 * These are curated, realistic-looking fixtures used across the public
 * demo, landing page, and dashboard when real integrations are not
 * available. They are never persisted and never presented as live facts.
 */
